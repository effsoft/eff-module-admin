<?php
use yii\helpers\Url;
use effsoft\eff\asset\fontawesome\FontawesomeAssetBundle;
use effsoft\eff\asset\jquery\JqueryAssetBundle;
use effsoft\eff\asset\bootstrap\bundle\BootstrapBundleAssetBundle;
use effsoft\eff\asset\jquery\easing\JqueryEasingAssetBundle;
use effsoft\eff\asset\magnific\popup\MagnificPopupAssetBundle;
...
BootstrapBundleAssetBundle::register($this);
JqueryEasingAssetBundle::register($this);
MagnificPopupAssetBundle::register($this);
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <!-- Page Heading -->
      <h1 class="h3 mb-2 text-gray-800"><?=Yii::t('eff-module-admin/app','Dashboard');?></h1>
      <p class="mb-4">
        开发完善中...
      </p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      ...
      <a class="btn btn-primary" href="<?=Url::to(['/passport/logout'], $schema = true)?>">Logout</a>
    </div>
  </div>
</div>
</div>
